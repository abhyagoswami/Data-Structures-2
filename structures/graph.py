...
class HuffmanNode(Node):
    ...
    def __str__(self):
        string = "node(" + str(self.get_id()) + ", " + str(self.get_data()) + ")"
        return string
    
    def set_left(self, node: HuffmanNode) -> None:
        self._left = node

    def set_right(self, node: HuffmanNode) -> None:
        self._right = node

    def set_parent(self, node: HuffmanNode) -> None:
        self._parent = node

    def set_child(self, node: HuffmanNode) -> None:
        self._child = node
    ...
    def get_parent(self) -> HuffmanNode:
        return self._parent
    
    def get_child(self) -> HuffmanNode:
        return self._child
