...
class DynamicArray:
    """
    A simplified *append only* dynamic array.
    """
    ...
    def resize_manual(self, value: int) -> None:
        """
        Given an integer value, resize the array to this.
        Note: This assumes that value > self._capacity currently.
        """
